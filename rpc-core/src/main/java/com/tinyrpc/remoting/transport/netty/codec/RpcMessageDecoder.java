...
import com.tinyrpc.compress.Compress;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    public RpcMessageDecoder() {
        // lengthFieldOffset: magic code is 4B, version is 1B, then full length. so value is 5.
     ...
     * @param lengthFieldOffset     Length filed offset. The length field is the one that skips the specified length of byte.
     * @param lengthFieldLength     The number of bytes in the length filed.
     * @param lengthAdjustment      The compensation value to add to the value of the length filed.
